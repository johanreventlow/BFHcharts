...
This specification defines requirements for code organization and DRY compliance in BFHcharts. It ensures that utility functions have single canonical implementations.
...
**Files to create:**
- `R/utils_time_formatting.R` - Canonical time formatting
- `R/utils_number_formatting.R` - Canonical number formatting

**Files to modify:**
- `R/utils_helpers.R` - Remove duplicate, use canonical
- `R/utils_y_axis_formatting.R` - Remove duplicates, use canonical
- `R/utils_label_formatting.R` - Remove duplicates, use canonical

**Testing requirements:**
- `tests/testthat/test-utils_time_formatting.R` - Time formatting tests
- `tests/testthat/test-utils_number_formatting.R` - Number formatting tests

## Validation

**DRY compliance checks:**
- ✅ `grep -r "format_time" R/` returns only one file
- ✅ `grep -r "format_count" R/` returns only one file
- ✅ No K/M/mia logic duplicated across files

**Functional checks:**
- ✅ All time formatting tests pass
- ✅ All number formatting tests pass
- ✅ Existing functionality unchanged (regression tests)
...
**R packages:**
- None (base R functionality)

**Related capabilities:**
- Y-axis formatting uses these utilities
- Label formatting uses these utilities
- Any future formatting uses these utilities
