...
- [x] 2.2 Test: `use_ai = TRUE` uden `BFHllm` installeret → informativ fejl (skip_if BFHllm installeret)
- [x] 2.3 Test: `use_ai = TRUE` med `BFHllm` → kalder bfhllm_spc_suggestion (skip_if_not_installed)
- [x] 2.4 Eksisterende tests var allerede eksplicitte (`use_ai = FALSE`); default-values test opdateret
